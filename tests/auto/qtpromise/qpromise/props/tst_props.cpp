...
class tst_qpromise_props : public QObject
{
    Q_OBJECT
...
QTEST_MAIN(tst_qpromise_props)
#include "tst_props.moc"
...
void tst_qpromise_props::propsNoPromises()
{
    auto in = std::make_tuple(
                42,
                QString("42"),
...
void tst_qpromise_props::propsMixed()
{
    auto in = std::make_tuple(
                QPromise<int>::resolve(42),
                QPromise<QString>::resolve(QLatin1String("42")),
...
void tst_qpromise_props::propsDelayed()
{
    auto in = std::make_tuple(
...
void tst_qpromise_props::propsReject()
{
    auto in = std::make_tuple(
                QPromise<int>::resolve(42),
...
void tst_qpromise_props::propsDelayedReject()
{
    auto in = std::make_tuple(
                delayResolve<int>(42, 200),
...
void tst_qpromise_props::chained()
{
    auto in = std::make_tuple(
                QPromise<int>::resolve(42),
                QPromise<QString>::resolve(QLatin1String("42")),
